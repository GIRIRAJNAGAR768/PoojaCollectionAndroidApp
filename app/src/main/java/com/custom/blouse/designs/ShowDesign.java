...
public class ShowDesign extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        horf = extra.getString("horf");

        dId.setText("Design Id: "+code);


        matrix = new Matrix();
        image.setImageMatrix(matrix);
        Glide.with(ShowDesign.this).load(link).into(image);
